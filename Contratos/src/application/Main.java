...
public class Main {
	public static void main(String[] args) throws ParseException {
		...
		//Instancioando um novo obj do tipo Worker, e associado a esse bj, terá um outro obj do tipo Departament
		...
		for (int i = 1; i <= n; i++) {
			...
			worker.addContract(contract); //faz com que o contrato seja associado ao trabalhador
		...
		System.out.println("Department " + worker
				.getDepartament()
				.getName());
