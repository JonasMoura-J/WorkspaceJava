...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Trim  - "+ s03); //elimina espaços após e antes da cadeia
		System.out.println("Substring  - "+ s04); //nova string a partir do caracter 2
		System.out.println("Substring  - "+ s05); //nova string a partir do caracter 2 e vai até a posição 9
